...
public abstract class AbstractAttack {
	...
	protected static int		TOP_Y			= 22;

	protected static int		LEFT_X			= 56;
	protected static int		LEFT_Y			= 307;

	protected static int		RIGHT_X			= 811;
	protected static int		RIGHT_Y			= 307;

	protected static int		BOTTOM_LEFT_X	= 339;
	protected static int		BOTTOM_LEFT_Y	= 536;

	protected static int		BOTTOM_RIGHT_X	= 516;
	protected static int		BOTTOM_RIGHT_Y	= 538;
	
	protected static final int	PAUSE_BETWEEN_UNIT_DROP = 75;
